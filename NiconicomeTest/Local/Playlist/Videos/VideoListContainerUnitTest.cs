    ...
    class VideoListContainerUnitTest
    {
        ...
        public void SetUp()
        {
            ...
            this.videoListContainer.ListChanged += (_, e) =>
            {
                ...
                this.lastVIdeoNicoID = e.Data?.NiconicoId;
            };
        }
        ...
        public void 動画を追加する()
        {
            ...
            Assert.That(this.videoListContainer.GetVideos().Count(), Is.EqualTo(1));
        ...
        public void 動画を削除する()
        {
            ...
            Assert.That(this.lastVIdeoNicoID, Is.EqualTo("sm9"));
            Assert.That(this.videoListContainer.GetVideos().Count(), Is.EqualTo(0));
            Assert.That(result.IsSucceeded, Is.True);
