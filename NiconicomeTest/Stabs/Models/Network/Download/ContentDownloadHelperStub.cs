...
namespace NiconicomeTest.Stabs.Models.Network.Download
{
    ...
    {
        public Task<IAttemptResult<IDownloadContext>> TryDownloadContentAsync(IVideoInfo videoInfo, IDownloadSettings setting, Action<string> OnMessage, CancellationToken token)
        {
