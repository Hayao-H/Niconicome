...
namespace NiconicomeTest.NetWork.Niconico.Search
{
    class SearchUrlConstructorUnitTest
    {
        ...
        public void タグ検索()
        {
            ...
            var expected = APIConstant.SnapshotAPIV2 + "?" + "q=東方&targets=tagsExact&_sort=-viewCounter&fields=contentId,title,viewCounter,mylistCounter,thumbnailUrl,startTime,commentCounter&_limit=50&_offset=0";
        ...
        public void タグ検索降順()
        {
            ...
            var result = this.searchUrlConstructor!.GetUrl(query);
            var expected = APIConstant.SnapshotAPIV2 + "?" + "q=東方&targets=tagsExact&_sort=%2bviewCounter&fields=contentId,title,viewCounter,mylistCounter,thumbnailUrl,startTime,commentCounter&_limit=50&_offset=0";
        ...
        public void タグ検索2ページ目()
        {
            ...
            var result = this.searchUrlConstructor!.GetUrl(query);
            var expected = APIConstant.SnapshotAPIV2 + "?" + "q=東方&targets=tagsExact&_sort=-viewCounter&fields=contentId,title,viewCounter,mylistCounter,thumbnailUrl,startTime,commentCounter&_limit=50&_offset=50";
        ...
        public void キーワード検索()
        {
            ...
            var result = this.searchUrlConstructor!.GetUrl(query);
            var expected = APIConstant.SnapshotAPIV2 + "?" + "q=東方&targets=title,description,tags&_sort=-viewCounter&fields=contentId,title,viewCounter,mylistCounter,thumbnailUrl,startTime,commentCounter&_limit=50&_offset=0";
        ...
        public void Jsonフィルタータグゲームジャンル()
        {
            ...
            var result = this.searchUrlConstructor!.GetUrl(query);
            var expected = APIConstant.SnapshotAPIV2 + "?" + "q=東方&targets=tagsExact&_sort=-viewCounter&fields=contentId,title,viewCounter,mylistCounter,thumbnailUrl,startTime,commentCounter&jsonFilter={\"type\":\"and\",\"filters\":[{\"type\":\"equal\",\"field\":\"genre\",\"value\":\"ゲーム\"}]}&_limit=50&_offset=0";
