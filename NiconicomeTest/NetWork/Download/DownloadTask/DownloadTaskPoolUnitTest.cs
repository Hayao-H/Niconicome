...
namespace NiconicomeTest.NetWork.Download.DownloadTask
{
    class DownloadTaskPoolUnitTest
    {
        ...
        {
            var task = new Download::DownloadTask(new PlaylistManagerStub(), new MessageHandlerStub(), new ContentDownloadHelperStub(), new StringHandler());
        ...
        {
            var task1 = new Download::DownloadTask(new PlaylistManagerStub(), new MessageHandlerStub(), new ContentDownloadHelperStub(), new StringHandler());
            var task2 = new Download::DownloadTask(new PlaylistManagerStub(), new MessageHandlerStub(), new ContentDownloadHelperStub(), new StringHandler());
            var task3 = new Download::DownloadTask(new PlaylistManagerStub(), new MessageHandlerStub(), new ContentDownloadHelperStub(), new StringHandler());
