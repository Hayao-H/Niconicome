...
using Err = Niconicome.Models.Domain.Niconico.Download.Video.V2.Fetch.Segment.Error.SegmentDownloaderError;
using SC = Niconicome.Models.Domain.Niconico.Download.Video.V2.Fetch.Segment.StringContent.SegmentDownloaderSC;
